  ...
  (
    ...
    if (isMobile) {
      return (
        <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
          <SheetContent
            className="w-[var(--sidebar-width)] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden bg-gradient-to-b from-blue-50 via-teal-50 to-green-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600"
            data-mobile="true"
    ...
    return (
      ...
      >
        ...
        >
          <div
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow bg-gradient-to-b from-blue-50 via-teal-50 to-green-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600"
            data-sidebar="sidebar"
          >
            {children}
          </div>
